...
This project parses all of them, maps the era-specific raw fields to a **single stable schema of 71 harmonized columns + 13 derived indicators** (V2 natality) and 81 + 16 (v4 linked: the 78 v3 columns + 3 within-era cohort columns), documents every era boundary and comparability constraint, and validates the output against NCHS "Births: Final Data" NVSR reports + the NCHS cohort linked-file user guides (205/205 V2 resident-birth targets pass for 1968–2024; 183/183 V2 rate/indicator targets for 1990–2024; linked 35/35 for 2005–2023 plus per-year byte-exact / within-tolerance for the pre-2005 cohort 1983–2004).
