...
This project parses all of them, maps the era-specific raw fields to a **single stable schema of 71 harmonized columns + 13 derived indicators** (V2 natality) and 81 + 16 (v4 linked: the 78 v3 columns + 3 within-era cohort columns), documents every era boundary and comparability constraint, and validates the output against NCHS "Births: Final Data" NVSR reports + the NCHS cohort linked-file user guides (215/215 V2 external validation targets pass (205 resident-births 1968–2024; 193 rate/indicator 1980–2024 including LBW 1980–1989 from childstats HEALTH1.B); linked 35/35 for 2005–2023 plus per-year byte-exact / within-tolerance for the pre-2005 cohort 1983–2004).
