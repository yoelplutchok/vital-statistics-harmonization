...
This project parses all of them, maps the era-specific raw fields to a **single stable schema of 71 harmonized columns + 13 derived indicators** (V2 natality) and 81 + 16 (v4 linked: the 78 v3 columns + 3 within-era cohort columns), documents every era boundary and comparability constraint, and validates the output against NCHS "Births: Final Data" NVSR reports + the NCHS cohort linked-file user guides (249/249 V2 external validation targets pass (56 resident-births 1968–2024; 44 LBW/preterm rate cells 1968–1989 from MVSR Final Natality / Registered Births and childstats HEALTH1.B 1980–1989; 149 other 1990+ rate/indicator cells); linked 35/35 for 2005–2023 plus per-year byte-exact / within-tolerance for the pre-2005 cohort 1983–2004).
...
| `output/harmonized/natality_v3_linked_harmonized_derived.parquet` | 149,386,620 | 100 | Linked birth-infant death 1983–2023 (permanent 1992–1994 gap), one row per birth (1989+); for the keyless 1983–1988 era den/num rows are tagged by `link_segment`. |
