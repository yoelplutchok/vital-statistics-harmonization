...
**Results: 249/249 targets pass.** Validated against NCHS *Births: Final Data* / NVSR reports, CDC Data API, NCHS Data Briefs, *Vital Statistics of the United States* / MVSR Final Natality volumes, and childstats HEALTH1.B series covering resident birth counts (1968–2024), LBW% and preterm% (1968–1989), and twin/triplet+, cesarean%, singleton%, male%, smoking%, and Medicaid% cells (1990–2024).

> **v3.0.0 scope note.** As of natality v3.0.0 the harmonized product spans **1968–2024** (57 years; 201,161,456 records — see `ABOUT_THIS_RELEASE.md`). External validation comprises **249** committed targets: **56** resident-birth counts (1968–2024; 1968–1988 SAMPWT-weighted from yearly raw parquets), **44** pre-1990 LBW/preterm rate cells (1968–1989), and **149** 1990+ rate/indicator cells (byte-identical to the v2.8 baseline for that slice, verified at C8.17 DO step 6). Machine-readable results: `output/validation/external_validation_v1_comparison.{csv,md}`.
