...
- **Linked-file validation framing.** The natality repo's README says "35/35 V3 linked targets pass." The drafts say "33/35 byte-exact + 2 cells differ by one record each from null-weight survivor records." One framing is stale; verify against `natality/output/validation/external_validation_v3_linked_comparison.md` before submission.
